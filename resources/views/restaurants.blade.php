<x-layout>
    ...
    <section class="bg-white py-12">
        <div class="container mx-auto px-4 max-w-7xl">
            ...
            <div class="mb-8 bg-[#FDF8F3] rounded-lg p-6 shadow-sm">
                <form method="GET" action="{{ route('menuDate.index') }}"
    ...
    <script>
        function addToCart(menuId, menuName, menuPrice, menuImages, menuDateId) {
        ...
        fetch('{{ route('cart.add') }}', {
            ...
            .then(data => {
                ...
                // Add additional success feedback here (e.g., toast notification).
            })
            .catch(error => {
                ...
                // Add additional error feedback here (e.g., toast notification).
            });
    }
